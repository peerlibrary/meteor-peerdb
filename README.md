...
those fields along with the reference, otherwise "denormalizing" them even though peerDB is all about keeping all instances of fields synced or normalized after original. For example, if you are displaying blog posts as denormalization goes, you want to display the author's name together
